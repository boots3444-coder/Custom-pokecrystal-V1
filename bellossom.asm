	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, CURSE, TOXIC, HIDDEN_POWER, SUNNY_DAY, SWEET_SCENT, SNORE, HYPER_BEAM, PROTECT, GIGA_DRAIN, ENDURE, FRUSTRATION, SOLARBEAM, RETURN, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, REST, ATTRACT, CUT, FLASH, MEGA_DRAIN, METRONOME, MEGA_PUNCH, REFLECT, SUBMISSION, SEISMIC_TOSS, LIGHT_SCREEN, BODY_SLAM, MEGA_KICK, DOUBLE_EDGE, SWORDS_DANCE, COUNTER, SUBSTITUTE
	; end
